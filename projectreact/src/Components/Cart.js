                        ...
                        {items.map((item, index)=>{
                            return(
                                <tr key={index}>
                                    ...
                                    <td>
                                        <Button onClick={()=> updateItemQuantity(item.productId, item.quantity - 1)} className="ms-2">-</Button>
                                        <Button onClick={()=> updateItemQuantity(item.productId, item.quantity + 1)} className="ms-2">+</Button>
                                        <Button variant="danger" onClick={()=> removeItem(item.productId)} className="ms-2">Remove Item</Button>
                                    </td>
                                </tr>
                            )
                        })}
